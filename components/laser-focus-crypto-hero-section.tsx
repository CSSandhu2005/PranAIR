...
export function LaserHero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden bg-black w-full">
              ...
              {user === null ? (
                <>
                  ...
                  <SignInButton mode="modal">
                    <button className="bg-white cursor-pointer text-black hover:bg-gray-100 px-6 py-2 rounded-full font-medium transition-colors duration-200 flex items-center gap-2">
                      Login
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center pt-20 pb-16">
        <div className="xl:max-w-7xl max-w-6xl  w-full mx-auto lg:px-0 px-6">
          <div className="inline-flex items-center gap-2 px-2 py-1 rounded-full bg-stone-800/50 pr-3 backdrop-blur-sm border border-stone-600/30 mb-8">
            <span className="px-2 py-0.5 bg-red-500 text-red-100 text-xs font-bold rounded-full">
              New
            </span>
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-balance mb-6 text-white leading-tight">
            Drones Ready
            <br />
            <span className="text-gray-300">for Any Emergency</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl text-gray-300 text-balance mb-12 max-w-2xl leading-relaxed">
            AI-powered emergency response system. Rapid deployment, intelligent routing, and real-time coordination for critical situations
          </p>
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 z-1 bg-linear-to-t from-black/60 via-transparent to-black/40 pointer-events-none" />
    </section>
  );
}
